 ...
 * Generated on: 2025-08-20T11:06:39.035Z
...
test.describe('Jornada de compra', () => {
  test('Generated from Chrome Recording', async ({ page, dataLayer }) => {
    ...
    expect(dataLayer).toHaveEvent('click', {
      element_type: 'button',
      element_selector: 'div:nth-of-type(5) > div > div > div:nth-of-type(1) > div > div > div:nth-of-type(2) > button'
    });
    // TODO: Verify click event and adjust expected data
